                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class=" @error('categorie_activite_id') has-danger @enderror">
                                        ...
                                        <br>
                                        <select name="categorie_activite_id" id="categorie_activite_id" value="{{ old('categorie_activite_id') }}" class="form-control @error('categorie_activite_id') is-invalid @enderror">
                                    ...
                                    <div class=" @error('groupe_id') has-danger @enderror">
                                        ...
                                        <br>
                                        <select name="groupe_id" id="groupe_id" value="{{ old('groupe_id') }}" class="form-control @error('groupe_id') is-invalid @enderror">
                                            <option value="" disabled >-- <i>Choisir dans la liste</i></option>
