                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group @error('date_debut') has-danger @enderror">
                                        <label for="nom" class="bmd-label-floating0 @error('date_debut') text-danger @enderror">Date debut</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group @error('date_fin') has-danger @enderror">
                                        <label for="nom" class="bmd-label-floating0 @error('date_fin') text-danger @enderror">Date fin</label>
                                ...
                                <div class="form-group">
                                    <button id="btn-send" type="submit" class="btn btn-primary"><i class="material-icons">send</i> Envoyer</button>
                                </div>
                            </div>
