                                ...
                                <div class="container">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" disabled value="{{ $pays->sousZone?->nom }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="col-form-label">Pays</label>
                                            <input type="hidden" name="pays_id" value="{{ $pays->id }}">
                                            <input type="text" class="form-control" disabled value="{{ $pays->nom }}">
                                        </div>
                                    </div>
                                    @php
                                            ...
                                            <div class="resp-panel">
                                                ...
                                                @foreach($leftHalf as $responsabilite)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-select">
                                                            <select name="responsabilite_pays[{{ $responsabilite->id }}]" class="responsable-select form-control">
