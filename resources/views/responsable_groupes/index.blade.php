@extends('layouts.app')
@section('page_title') Responsables de Groupes @endsection
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Liste des responsables de groupes</h4>
                    </div>
                    <div class="card-body">
                        <div class="toolbar">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function () {
            $fileName = 'LISTE DES RESPONSABLES DE GROUPES';
            $('.dataTable').DataTable({
                layout: {
                    topStart: {
                        buttons: [
