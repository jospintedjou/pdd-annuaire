@extends('layouts.app')
@section('page_title') Tableau de bord des <span class="text-primary">Zones</span>  @endsection
@section('content')
    <div class="content">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function () {
            $fileName = 'TABLEAU DES STATISTIQUES GLOBALES DES ZONES';
            $('.dataTable').DataTable({
                layout: {
                    topStart: {
                        buttons: [
