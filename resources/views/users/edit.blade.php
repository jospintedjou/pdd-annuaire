                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 @error('sexe') has-danger @enderror">
                                        ...
                                        <select name="sexe" id="sexe" class="selectpicker" 
                                            data-width="100%"data-size="auto" data-style="select-with-transition"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 @error('categorie_sociale') has-danger @enderror">
                                        ...
                                        <select name="categorie_sociale" id="categorie_sociale" class="selectpicker" 
                                            data-width="100%"data-size="auto" data-style="select-with-transition"
                                    ...
                                    <div class="form-group col-md-4 @error('apostolat_id') has-danger @enderror">
                                        ...
                                        <select name="apostolat_id[]" id="apostolat_id" class="selectpicker" 
                                            data-width="100%"data-size="auto" data-style="select-with-transition"
                                                data-actions-box="true" data-live-search="true"
                                    ...
                                    <div class="form-group col-md-4 @error('niveau_engagement_id') has-danger @enderror">
                                        ...
                                        <select name="niveau_engagement_id" id="niveau_engagement_id" class="selectpicker" 
                                            data-width="100%"data-size="auto" data-style="select-with-transition"
                                                data-actions-box="true" data-live-search="true"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 @error('groupe_id') has-danger @enderror">
                                        ...
                                        <select name="groupe_id" id="groupe_id" class="selectpicker" 
                                            data-width="100%"data-size="auto" data-style="select-with-transition"
                                                data-actions-box="true" data-live-search="true"
                                    ...
                                    <div class="form-group col-md-4 @error('etat') has-danger @enderror">
                                        ...
                                        <select name="etat" id="etat" class="selectpicker" 
                                            data-width="100%"data-size="auto" data-style="select-with-transition"
